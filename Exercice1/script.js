...
function calculateTip() {
    ...
    /**
     * @description cette fonction permet de calculer le pourboir que chaque personne doit laisser
    ...
    if(serviceQuality == 0 || billAmount.length == 0) {
        alert("S'il vous plaît, entrez la qualité du service et la facture du montant");
    }
